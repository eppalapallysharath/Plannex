...
const {createEvent, getAllEvents, getEvent, updateEvent, deleteEvent, myevent} = require("../controllers/event.js")
...
router.get("/my-events", validateAuthHeaders,validation, authentication,authorization("organizer"),myevent )
